...
class LSTM_FCNs(nn.Module):
    def __init__(self, *, n_time = 720, num_classes_1, num_classes_2,  input_size, num_lstm_out=64, num_layers,
        ...
        self.fc_1 = nn.Linear(self.conv3_nf+self.num_lstm_out, self.num_classes_1)
    ...
    def forward(self, x):
        ...
        x_out_1 = self.fc_1(x_all)
        x_out_1 = F.log_softmax(x_out_1, dim=1)
        
        x_out_2 = self.fc_2(x_all)
